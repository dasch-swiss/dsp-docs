...
- Ensuring that all user-created ontologies are consistent and conform to [knora-base](../../ontologies/knora-base.md).
...
2. Checks user-created ontologies for consistency and conformance to `knora-base`,
   ...
   [Summary of Restrictions on User-Created Ontologies](../../ontologies/knora-base.md#summary-of-restrictions-on-user-created-ontologies).
...
as explained in
[Ontology Updates](../../api-reference/api-v2/ontology-information.md#ontology-updates).
