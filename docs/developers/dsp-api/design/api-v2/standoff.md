...
- In particular, [Gravsearch](../../api-reference/api-v2/query-language.md) queries should be able
...
In Knora, it is possible to define [mappings](../../api-reference/api-v2/xml-to-standoff-mapping.md) to
