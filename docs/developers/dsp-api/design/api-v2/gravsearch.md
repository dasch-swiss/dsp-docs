...
[Type Inference](../../api-reference/api-v2/query-language.md#type-inference), these types can be inferred,
...
- `AnnotationReadingGravsearchTypeInspector`: reads
   [type annotations](../../api-reference/api-v2/query-language.md#type-annotations) included in a Gravsearch query.
...
(see [Inference](../../api-reference/api-v2/query-language.md#inference) in the API documentation
