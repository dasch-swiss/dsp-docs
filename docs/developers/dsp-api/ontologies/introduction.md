...
extend DSP-API's built-in ontologies. The main built-in ontology in DSP-API
is [knora-base](knora-base.md).

## Shared Ontologies

DSP-API does not normally allow a project to use classes or properties defined in
